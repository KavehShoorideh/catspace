#!/usr/bin/env python
"""experiments/compute_layer.py -- the COMPUTATION / SIMULATION layer the planner sits on top of
...
from experiments.stratified_mcts import StratifiedMCTS
...
def _demo():
    ...
    import numpy as np
    from experiments.value_fixed_point import tb_best_move  # noqa
    cl = ComputeLayer("data/derived/sep/iqe_stratified.pt", "data/derived/stratified_perfect.npz",
