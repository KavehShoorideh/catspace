#!/usr/bin/env python
"""experiments/train_quasimetric.py -- MULTI-GOAL QUASIMETRIC field MVP (Kaveh 2026-07-26).
...
def main():
    ...
    ap.add_argument("--data", default="data/derived/pairwise_tb_v1.npz")
    ap.add_argument("--dtm-data", default="data/derived/dtm_endgame_v2.npz",
