#!/usr/bin/env python
"""experiments/probe_tri_carry.py -- how far does the triangle-inequality carry work?
...
def main():
    ...
    ap.add_argument("--bank-file", default="artifacts/experiments/wdlr6_bank_n5000_KRRvK-central.fens")
    ap.add_argument("--field", default="data/derived/sep/lichess_mc2.pt")
    ap.add_argument("--results-glob", default="artifacts/experiments/wdlr[34]_results_n5000_*.jsonl,artifacts/experiments/drawreplay_results.jsonl")
