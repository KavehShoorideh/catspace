#!/usr/bin/env python
"""experiments/train_board_dtm.py — a BOARD-based distance-to-mate net (Kaveh
...
Usage:
  .venv/bin/python experiments/train_board_dtm.py --epochs 80 \
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/sep/board_dtm.pt")
