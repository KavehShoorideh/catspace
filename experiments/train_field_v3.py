#!/usr/bin/env python
"""experiments/train_field_v3.py -- corrected mate field using the TESTED loss module
(experiments/losses.py). Closes the loop: mate attractor + WDL hinge barrier + TIE-SAFE
...
def main():
    ...
    ap.add_argument("--save", default="artifacts/experiments/field_v3.pt")
