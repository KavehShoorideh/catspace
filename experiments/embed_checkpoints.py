#!/usr/bin/env python
"""experiments/embed_checkpoints.py -- Stage 1b: phi-embed the mined checkpoint corpus
...
def main():
    ...
    ap.add_argument("--data", default="data/derived/checkpoints/checkpoints_v1_full.npz")
    ap.add_argument("--table", default="data/derived/reach/region_table_v4.npz")
    ap.add_argument("--out", default="data/derived/checkpoints/checkpoints_v1_emb.npz")
    args = ap.parse_args()
    t0 = time.time()
