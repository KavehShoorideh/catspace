#!/usr/bin/env python
"""experiments/balance_game_records.py -- STAGE B of the identity-preserving data pipeline.
...
def main():
    ...
    ap.add_argument("--records", default="data/records/smoke_lichess")
    ...
    ap.add_argument("--report-json", default="artifacts/experiments/records_evenness.json")
    args = ap.parse_args()
    t0 = time.time()
