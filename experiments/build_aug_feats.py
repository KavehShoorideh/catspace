#!/usr/bin/env python
"""experiments/build_aug_feats.py -- human-axis features for the AUGMENTED codebook (the fired
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/reach/aug_feats_v2.npz")
    args = ap.parse_args()
