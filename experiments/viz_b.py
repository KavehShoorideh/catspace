#!/usr/bin/env python
"""experiments/viz_b.py -- visualize the B (goal-side) embedding (Kaveh 2026-07-21). B(g) is where "mate is a
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/viz_b.png")
