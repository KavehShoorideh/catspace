#!/usr/bin/env python
"""experiments/gen_transition_data.py -- M2a data: training examples for the TRANSITION ESTIMATOR
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/transition_data.npz")
