#!/usr/bin/env python
"""experiments/train_hazard_head.py -- Stage 2 of the anchored-JEPA plan (Kaveh's draft
...
def main():
    ...
    ap.add_argument("--data", default="data/derived/checkpoints/checkpoints_v1_emb.npz")
    ap.add_argument("--out", default="artifacts/experiments/hazard_v0")
