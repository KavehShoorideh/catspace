#!/usr/bin/env python
"""experiments/train_occupancy_field.py -- the L2 adversarial value field, trained on the
...
def main():
    ...
    ap.add_argument("--data", default="data/derived/optimal_occupancy.npz")
    ap.add_argument("--probe-data", default="data/derived/stratified_perfect.npz")
    ap.add_argument("--out", default="data/derived/sep/iqe_occupancy.pt")
    ...
    live_stem = Path("artifacts/experiments") / (Path(args.out).stem + "_curves")
