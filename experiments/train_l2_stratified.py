#!/usr/bin/env python
"""experiments/train_l2_stratified.py -- the L2 adversarial OUTCOME head on the FROZEN stratified
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/sep/l2_stratified.pt")
