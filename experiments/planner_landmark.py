#!/usr/bin/env python
"""experiments/planner_landmark.py -- PHASE 1 of the subgoal planner (Kaveh 2026-07-20):
...
Usage:
  .venv/bin/python experiments/planner_landmark.py --query-dtm 24 --k-plans 4
"""
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/planner_landmark.png")
