#!/usr/bin/env python
"""experiments/conversion_board_policy.py — AlphaZero recipe: MCTS with the
...
Usage:
  .venv/bin/python experiments/conversion_board_policy.py --n 30 --nodes 400
"""
...
def main():
    ...
    ap.add_argument("--board-policy", default="data/derived/sep/board_policy.pt")
