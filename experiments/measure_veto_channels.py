#!/usr/bin/env python
"""experiments/measure_veto_channels.py -- THE PUBLICATION GATE (Kaveh 2026-07-23): does the
...
def main():
    ...
    ap.add_argument("--field", default="data/derived/sep/lichess_mc.pt")
    ap.add_argument("--shards", default="data/shards/sf_cont_endgame_v1")
