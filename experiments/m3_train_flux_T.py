#!/usr/bin/env python
"""experiments/m3_train_flux_T.py -- train the T flux scorer for the M3 subgoal API and package
...
def main():
    ...
    ap.add_argument("--table", default="data/derived/reach/region_table_v1k.npz")
    ap.add_argument("--out", default="artifacts/experiments/m3_flux_T")
