#!/usr/bin/env python
"""experiments/build_opp_positions.py -- reconstruct the OPPONENT's decision points from the M2b
...
so experiments/m2b_cache.py runs on it UNCHANGED (Maia candidates indexed in the mover frame).
"""
...
def main():
    ...
    ap.add_argument("--positions", default="data/derived/m2b/positions_dense.parquet")
    ap.add_argument("--out", default="data/derived/m2b/positions_dense_opp.parquet")
    args = ap.parse_args()
    t0 = time.time()
