#!/usr/bin/env python
"""experiments/adversarial_distance_validation.py -- validate the ADVERSARIAL-QUASIMETRIC
...
from experiments.value_fixed_point import TB, rollout, tb_best_move, white_pov_value
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/adversarial_distance.png")
