#!/usr/bin/env python
"""experiments/eval_agentive_lift.py -- did agentive fine-tuning improve the field's
...
from experiments.train_reach_head import ReachHead                      # noqa: E402
...
def main():
    ...
    ap.add_argument("--data", default="data/derived/reach/agentive_v1.npz")
    ap.add_argument("--base", default="artifacts/experiments/reach_v3_full_latest.pt")
    ap.add_argument("--tuned", default="artifacts/experiments/reach_v4_agentive_latest.pt")
    args = ap.parse_args()
    dev = "cpu"
