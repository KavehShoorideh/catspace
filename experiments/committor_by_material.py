#!/usr/bin/env python
"""experiments/committor_by_material.py -- stack the committor / outcome distribution BY MATERIAL
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/committor_by_material.png")
