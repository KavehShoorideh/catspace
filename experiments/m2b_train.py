#!/usr/bin/env python
"""experiments/m2b_train.py -- M2b step 3: jointly fit the style-axis head U, the per-train-player
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/m2b_style.pt")
