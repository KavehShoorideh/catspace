#!/usr/bin/env python
"""experiments/strata_diag.py — are STRATA forming? (Kaveh 2026-07-19: some moves
...
def main():
    ...
    for name, ckpt in [("incumbent", "data/derived/sep/cert_base_full.pt"),
                       ("QRL (unreach-trained)", "data/derived/sep/qrl_iqe_sn_full.pt"),
                       ("clustered", "data/derived/sep/cert_base_cluster.pt")]:
