#!/usr/bin/env python
"""experiments/distill_finetune.py -- can the field LEARN 6-piece DTM from targets? (Kaveh 2026-07-21:
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/sep/nucleus_distilled.pt")
