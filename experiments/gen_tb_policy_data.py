#!/usr/bin/env python
"""experiments/gen_tb_policy_data.py — label each DTM position with its
...
Usage:
  .venv/bin/python experiments/gen_tb_policy_data.py --workers 9 \
...
from catspace.nn.policy_head import move_index
...
def main():
    ...
    ap.add_argument("--in", dest="inp", default="data/derived/dtm_endgame.npz")
    ap.add_argument("--out", default="data/derived/dtm_policy.npz")
