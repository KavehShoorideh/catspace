#!/usr/bin/env python
"""experiments/register_incumbents.py -- port the CURRENT incumbent models + datasets into
...
MODELS = [
    dict(name="iqe_geom_field", path="data/derived/sep/iqe_geom_field.pt",
    ...
    dict(name="lichess_sharp", path="data/derived/sep/lichess_sharp.pt",
    ...
    dict(name="dtm_cnn", path="data/derived/sep/dtm_cnn.pt",
    ...
    dict(name="nucleus_distilled", path="data/derived/sep/nucleus_distilled.pt",
...
MODELS.append(
    dict(name="lichess_mc", path="data/derived/sep/lichess_mc.pt",
...
DATASETS = [
    dict(name="geom_pool", path="data/derived/geom_pool.npz",
         desc="357,223 toy-tree positions + DTM labels", use="L_pos/L_hard positions; DTM labels"),
    dict(name="geom_pool_edges", path="data/derived/geom_pool_edges.npz",
         desc="2,172,150 legal 1-ply edges, 9% irreversible", use="L_pos / L_hard"),
    dict(name="sf_cont_endgame_v1", path="data/shards/sf_cont_endgame_v1/",
    ...
    dict(name="dtm_endgame", path="data/derived/dtm_endgame.npz",
    ...
    dict(name="contrast_mate_tuples", path="data/derived/contrast_mate_tuples.npz",
    ...
    dict(name="lichess_prefixes", path="data/shards/lichess_db_standard_rated_2019-01.prefix{256mb,1gb,4gb}/",
         desc="human games 2019-01; 2.54% <=6-piece; ~3M/12M/48M positions", use="human field; mate harvesting"),
    dict(name="krrkbp_test_n200", path="artifacts/experiments/krrkbp_test_n200.json",
         desc="200 FROZEN KRRvKBP starts", use="the conversion eval set (never re-sample)"),
    dict(name="stratified_perfect", path="data/derived/stratified_perfect.npz",
         desc="White-mate / winning-simplification region", use="long/short goal region"),
    dict(name="syzygy", path="data/syzygy/",
         desc="Syzygy WDL/DTZ tables: KRRvKBP family + simplifications", use="exact play/defense; label generation"),
    dict(name="regime_random_v1", path="data/shards/regime_random_v1/",
    ...
    dict(name="regime_rollouts_v1", path="data/shards/regime_rollouts_v1/",
    ...
    dict(name="move_selection_v1", path="data/derived/move_selection_v1.npz",
