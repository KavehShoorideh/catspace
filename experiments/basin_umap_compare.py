#!/usr/bin/env python
"""experiments/basin_umap_compare.py -- Kaveh's ask (2026-08-02): embed both the
...
def main():
    ...
    ap.add_argument("--human-records-dir", default="data/records/lichess_2019-01")
    ap.add_argument("--n", type=int, default=15000)
    ap.add_argument("--n-trajectories", type=int, default=25)
    ap.add_argument("--seed", type=int, default=0)
    ap.add_argument("--out-prefix", default="artifacts/experiments/basin_umap")
    args = ap.parse_args()
    t0 = time.time()
    ...
    fig.savefig("docs/figures/basin_umap_1_2_side_by_side.png", dpi=140)
    ...
    fig2.savefig("docs/figures/basin_umap_3_difference.png", dpi=140)
    ...
    fig4.savefig("docs/figures/basin_umap_4_trajectories.png", dpi=140)
    ...
    fig5.savefig("docs/figures/basin_umap_5_trajectories_on_basins.png", dpi=140)
    ...
    fig6.savefig("docs/figures/basin_umap_6_single_games_spatial.png", dpi=140)
    ...
    fig7.savefig("docs/figures/basin_umap_7_basin_value_vs_ply.png", dpi=140)
