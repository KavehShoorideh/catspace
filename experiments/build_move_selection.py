#!/usr/bin/env python
"""experiments/build_move_selection.py -- materialize (position, legal-move set, move PLAYED,
...
experiments/train_opponent_model.py.
"""
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/move_selection_v1.npz")
