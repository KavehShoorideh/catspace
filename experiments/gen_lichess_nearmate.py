#!/usr/bin/env python
"""experiments/gen_lichess_nearmate.py — the near-mate NUCLEUS from REAL Lichess
...
Usage:
  .venv/bin/python experiments/gen_lichess_nearmate.py --workers 9 --cap 60000
"""
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/lichess_nearmate.npz")
