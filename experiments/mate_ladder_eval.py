#!/usr/bin/env python
"""experiments/mate_ladder_eval.py -- THE MATE MISSION EXAM (Kaveh 2026-07-23: "get the
...
def main():
    ...
    ap.add_argument("--dtm-ckpt", default="data/derived/sep/dtm_cnn.pt")
    ap.add_argument("--escape-ckpt", default="data/derived/sep/escape_net_v1.pt")
    ap.add_argument("--blend-w", type=float, default=0.5)
    ap.add_argument("--energy-ckpt", default="data/derived/sep/opponent_energy_v1_step8000.pt")
...
def make_field_value(field_ckpt="data/derived/sep/iqe_geom_field.pt", device="cpu", c=6.0):
    ...
    mates, _labels = harvest_mates("data/derived/dtm_endgame.npz", 400, rng)
...
def make_energy_prior(ckpt="data/derived/sep/opponent_energy_v1.pt", cohort=11, device="cpu"):
