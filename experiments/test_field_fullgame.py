#!/usr/bin/env python
"""experiments/test_field_fullgame.py -- TEST the trained full-board field (Kaveh: "then test it").
...
from experiments.train_field_fullgame import load_field_data
...
def main():
    ...
    ap.add_argument("--ckpt", default="artifacts/experiments/field_fullgame_latest.pt")
