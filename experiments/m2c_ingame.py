#!/usr/bin/env python
"""experiments/m2c_ingame.py -- M2c: in-game z tightening. As a player's moves ARRIVE (Kaveh: "z from
...
from catspace.style.recover import recover_delta, _precompute_U
