#!/usr/bin/env python
"""
experiments/build_position_memory.py — seed the position MEMORY (the vector
...
Usage:
  .venv/bin/python experiments/build_position_memory.py            # incumbent, n=200k
  .venv/bin/python experiments/build_position_memory.py --ckpt <field>.pt --n 500000
"""
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/position_memory")
