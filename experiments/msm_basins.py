#!/usr/bin/env python
"""experiments/msm_basins.py -- MARKOV STATE MODEL on the trained field: let the metastable basins
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/msm_basins.png")
