#!/usr/bin/env python
"""experiments/self_retrain_loop.py -- THE SELF-RETRAINING LOOP (Kaveh 2026-07-25:
...
def current_field(default="data/derived/sep/lichess_mc2.pt") -> str:
...
def main():
    ...
    ap.add_argument("--base-shards", default="data/shards/lichess_db_standard_rated_2019-01.prefix4gb")
    ...
    for rnd in range(args.rounds):
        ...
        if since_retrain >= args.retrain_every:
            ...
            new_ckpt = f"data/derived/sep/self_field_r{k}.pt"
            ...
            subprocess.run([sys.executable, "experiments/train_lichess_fb.py",
