#!/usr/bin/env python
"""experiments/mine_checkpoints.py -- Stage 1 of the anchored-JEPA plan (Kaveh's draft,
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/checkpoints/checkpoints_v0.npz")
