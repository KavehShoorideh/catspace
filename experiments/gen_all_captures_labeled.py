#!/usr/bin/env python
"""experiments/gen_all_captures_labeled.py -- expand the hanging-piece probe's data
...
experiments/hanging_piece_probe.py (real win-probability swing across a real
...
def main():
    ...
    ap.add_argument("--out", default="data/derived/all_captures_labeled.npz")
