#!/usr/bin/env python
"""experiments/viz_fb.py -- three FB-embedding visualizations (Kaveh 2026-07-21), per the FB / quasimetric-RL
...
def main():
    ...
    ap.add_argument("--field", default="data/derived/sep/xfer_treat_20k.pt")
    ap.add_argument("--dtm-npz", default="data/derived/dtm_endgame.npz")
    ap.add_argument("--lichess", default="data/shards/lichess_db_standard_rated_2019-01.prefix256mb")
    ...
    ap.add_argument("--out", default="artifacts/experiments/viz_fb.png")
