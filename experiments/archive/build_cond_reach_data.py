#!/usr/bin/env python
"""experiments/build_cond_reach_data.py -- assemble the z-CONDITIONED reachability training set for the
...
def main():
    cache = "data/derived/m2b/cache_3k.npz"; model_path = "artifacts/experiments/m2b_style_3k.pt"
    out = "data/derived/cond_reach_data.npz"
    t0 = time.time()
    z = load_cache(cache)
