#!/usr/bin/env python
"""experiments/ab_test.py -- ANYTIME-VALID A/B TEST between two model endpoints (Kaveh:
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/ab_pairs.jsonl")
    ap.add_argument("--live", default="artifacts/experiments/ab_live.json")
    args = ap.parse_args()
    t0 = time.time()
