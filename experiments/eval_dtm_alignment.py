#!/usr/bin/env python
"""experiments/eval_dtm_alignment.py — STABLE alignment readout for a field
...
Usage:
  .venv/bin/python experiments/eval_dtm_alignment.py --ckpt data/derived/sep/qrl_dtm_surf_step10000.pt
"""
...
def main():
    ...
    ap.add_argument("--ckpt", default="data/derived/sep/qrl_dtm_surf.pt")
