#!/usr/bin/env python
"""experiments/transition_map.py -- MAP THE HUMAN TRANSITION POINTS (Kaveh's metastability focus).
...
def main():
    ...
    ap.add_argument("--out", default="artifacts/experiments/transition_map.png")
