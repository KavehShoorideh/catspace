#!/usr/bin/env python
"""tools/fig_probe_curve.py -- THE headline evaluation figure of the JEPA
...
Usage:
  tools/fig_probe_curve.py --reps 5000:s5k.npz 10000:s10k.npz 20000:s20k.npz \
...
from tools.probe_rank import rankme                                     # noqa: E402
