...
from catspace.research.tools.chess_specific.opponents import optimal_reply_table, RandomOpponent, EpsOptimalDTM, TableOpponent
from catspace.research.tools.chess_specific.chain import KIND_ONGOING
