#!/usr/bin/env python
"""catspace/incubator/archived_experiments/build_cond_flux_data.py -- combined set to test z-CONDITIONED REACHABILITY-TO-OUTCOMES
...
def main():
    ...
    ap.add_argument("--positions", default=paths.derived("m2b/positions_3k.parquet"))
    ...
    ap.add_argument("--n-players", type=int, default=400); ap.add_argument("--out", default=paths.derived("cond_flux_data.npz"))
