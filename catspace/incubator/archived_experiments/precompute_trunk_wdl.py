#!/usr/bin/env python
"""catspace/incubator/archived_experiments/precompute_trunk_wdl.py -- cache the FROZEN T1 trunk's 3-way WDL (win/draw/loss, side-to-
...
def main():
    data = paths.derived("transition_data_labeled.npz")
    out = paths.derived("m2a_trunk_wdl.npy")
    t0 = time.time()
