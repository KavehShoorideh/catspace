#!/usr/bin/env python
"""catspace/incubator/archived_experiments/train_cond_reach2.py -- z-conditioned reachability with the PROBABILITY-ADJUSTED target
...
from catspace.research.tools.training_infra.losses import quasimetric_regression, reachability_target
...
def main():
    ...
    ap.add_argument("--cache", default=paths.derived("m2b/cache_dense"))
