#!/usr/bin/env python
"""catspace/incubator/archived_experiments/train_cond_field.py -- the CONTEXT-CONDITIONED reachability head (MILESTONES decision 3
...
def main():
    ...
    ap.add_argument("--wdl", default=paths.derived("m2a_trunk_wdl.npy"))
