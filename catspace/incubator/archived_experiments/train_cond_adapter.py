#!/usr/bin/env python
"""catspace/incubator/archived_experiments/train_cond_adapter.py -- the z-CONDITIONED reachability ADAPTER (Kaveh 2026-07-27, decision
...
from catspace.research.tools.training_infra.losses import quasimetric_regression
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("cond_reach_data.npz"))
