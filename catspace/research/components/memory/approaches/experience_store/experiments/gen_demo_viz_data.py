#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/gen_demo_viz_data.py -- EXACT (tablebase-ground-truth) data for the veto
...
def main():
    ...
    Path(paths.experiment("demo_viz_data.json")).write_text(json.dumps(out))
    eng.quit(); tb.close()
