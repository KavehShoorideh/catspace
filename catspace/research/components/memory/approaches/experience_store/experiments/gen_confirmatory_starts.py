#!/usr/bin/env python
"""
catspace/research/components/memory/approaches/experience_store/experiments/gen_confirmatory_starts.py — mint the FROZEN confirmatory start set.
...
def main():
    ...
    ap.add_argument("--exclude", nargs="+",
                    default=[paths.experiment("krrkbp_fixed_train_n700.json"),
                             paths.experiment("krrkbp_fixed_test_n200.json")])
    ap.add_argument("--syzygy-dir", default=str(paths.syzygy_dir()))
    ap.add_argument("--out",
                    default=paths.experiment("confirmatory_krrkbp_seed777_n120.json"))
    args = ap.parse_args()
