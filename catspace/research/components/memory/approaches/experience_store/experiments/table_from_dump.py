#!/usr/bin/env python
"""
catspace/research/components/memory/approaches/experience_store/experiments/table_from_dump.py — build a certainty table from a rollout dump.
...
def main():
    ...
    ap.add_argument("--dump", nargs="+",
                    default=[paths.experiment("rollout_dump_fixedstart.jsonl")],
