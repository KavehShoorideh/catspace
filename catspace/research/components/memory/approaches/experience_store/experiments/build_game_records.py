#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/build_game_records.py -- STAGE A of the identity-preserving data pipeline.
...
def main():
    ...
    ap.add_argument("--pgn", default=paths.lichess("lichess_db_standard_rated_2019-01.prefix256mb.pgn.zst"))
    ap.add_argument("--out", default=paths.records("lichess_2019-01"))
