#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/gen_clock_child_data.py -- CLOCK-AWARE child-rank data (Kaveh: represent the
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("clock_child_v1.npz"))
