#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/gen_opening_pool_sfsf.py -- full-strength, DETERMINISTIC Stockfish-vs-Stockfish
...
def play_shard(lines, depth, cap, stride, per_game, tail, syzygy, gid0):
    ...
    from catspace.research.components.planner.approaches.committor_value.experiments.value_fixed_point import white_pov_value, tb_best_move
...
def main():
    ...
    ap.add_argument("--pool", default=paths.derived("opening_pool_ply8.txt"))
    ...
    ap.add_argument("--out", default=paths.derived("opening_pool_sfsf.npz"))
