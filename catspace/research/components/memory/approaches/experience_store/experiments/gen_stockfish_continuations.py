#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/gen_stockfish_continuations.py -- BEST-PLAY continuations from sampled human positions
...
def main():
    ...
    ap.add_argument("--syzygy", default=str(paths.syzygy_dir()), help="tablebase dir; once <=frontier pieces, COMPLETE the line to mate exactly")
    ...
    ap.add_argument("--out-dir", default=paths.shards("stockfish_continuations"))
