#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/mine_only_move_bottlenecks.py -- find "only move" positions: where
...
Usage:
  catspace/research/components/memory/approaches/experience_store/experiments/mine_only_move_bottlenecks.py --n 200 --workers 8
"""
...
def main():
    ...
    ap.add_argument("--moves", default=paths.derived("opening_pool_sfsf_moves.tsv"))
    ap.add_argument("--n", type=int, default=200, help="number of positions to sample")
    ap.add_argument("--depth", type=int, default=12)
    ap.add_argument("--workers", type=int, default=0)
    ap.add_argument("--seed", type=int, default=0)
    ap.add_argument("--out", default=paths.experiment("only_move_bottlenecks.npz"))
    args = ap.parse_args()
    t0 = time.time()
