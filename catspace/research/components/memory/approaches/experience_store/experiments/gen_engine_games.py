#!/usr/bin/env python
"""catspace/research/components/memory/approaches/experience_store/experiments/gen_engine_games.py -- generate STRONG-ENGINE-vs-STRONG-ENGINE games (Stockfish vs
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("engine_sfsf.npz"))
