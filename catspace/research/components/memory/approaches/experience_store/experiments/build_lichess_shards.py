#!/usr/bin/env python
"""
catspace/research/components/memory/approaches/experience_store/experiments/build_lichess_shards.py — stream-filter-encode-shard a Lichess
...
frame up to the cut):
    ...
    python catspace/research/components/memory/approaches/experience_store/experiments/build_lichess_shards.py \\
