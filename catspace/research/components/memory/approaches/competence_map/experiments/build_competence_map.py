#!/usr/bin/env python
"""
catspace/research/components/memory/approaches/competence_map/experiments/build_competence_map.py — build the Method-2 competence map
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("competence_map.npz"))
    args = ap.parse_args()
