#!/usr/bin/env python
"""catspace/research/components/search/approaches/puct_mcts/experiments/m5_mcts_probe.py -- M5 probe: thin CLI over the modular stack in
...
def main():
    ...
    ap.add_argument("--save-pgn", default=paths.experiment("m5_probe.pgn"))
    args = ap.parse_args()
