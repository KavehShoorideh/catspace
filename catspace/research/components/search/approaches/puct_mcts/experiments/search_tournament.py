#!/usr/bin/env python
"""
catspace/research/components/search/approaches/puct_mcts/experiments/search_tournament.py — which SEARCH is better, statistically?
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("search_tournament.jsonl"))
    args = ap.parse_args()
