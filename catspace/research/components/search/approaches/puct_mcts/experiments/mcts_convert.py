#!/usr/bin/env python
"""catspace/research/components/search/approaches/puct_mcts/experiments/mcts_convert.py -- S2c (METASTABILITY_PLAN, Kaveh): demonstrate we can CONVERT
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.mate_with_search import load
