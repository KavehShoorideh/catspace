#!/usr/bin/env python
"""catspace/research/components/search/approaches/puct_mcts/experiments/search_outcome.py -- OUTCOME VIA SEARCH (Kaveh 2026-07-20, M2 pivot). The
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("search_outcome.png"))
