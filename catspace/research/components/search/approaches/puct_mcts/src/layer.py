...
catspace.research.components.search.approaches.puct_mcts.src.mcts.MCTS with the (value, prior) sockets and returns a SearchOutcome with
...
from catspace.interfaces import SearchOutcome
