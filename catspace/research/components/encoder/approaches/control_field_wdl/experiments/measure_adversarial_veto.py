#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/control_field_wdl/experiments/measure_adversarial_veto.py -- Kaveh 2026-07-22: cooperative vs adversarial
...
def main():
    ...
    args = ap.parse_args()
    t0 = time.time(); rng = np.random.default_rng(args.seed); tb = TB(str(paths.syzygy_dir()))
