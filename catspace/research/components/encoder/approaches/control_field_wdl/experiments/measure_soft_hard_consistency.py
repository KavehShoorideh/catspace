#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/control_field_wdl/experiments/measure_soft_hard_consistency.py -- do the SOFT (rho head, -log-odds) and HARD
...
def main():
    ...
    ap.add_argument("--rho", default=paths.sep("rho_head_v1.pt"))
    ...
    from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.train_rho_head import RhoHead
