#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_field_geometry.py -- the SIMPLIFIED geometry objective
...
Usage:
  .venv/bin/python catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_field_geometry.py --steps 3000 \
...
def main():
    ...
    ap.add_argument("--edges", default=paths.derived("successor_edges.npz"))
    ap.add_argument("--pawndeath", default=paths.derived("pawndeath_pairs.npz"), help="EVAL probe only")
    ap.add_argument("--out", default=paths.sep("iqe_geom.pt"))
