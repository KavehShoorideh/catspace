#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_geometry_min.py -- the MINIMAL L1 reachability geometry
...
def main():
    ...
    ap.add_argument("--edges", default=paths.derived("successor_edges_all.npz"))
    ap.add_argument("--out", default=paths.sep("iqe_geom_min.pt"))
