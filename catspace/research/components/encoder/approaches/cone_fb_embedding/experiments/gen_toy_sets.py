#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/gen_toy_sets.py — mint the fixed-start toy TRAIN/EVAL sets.
...
from catspace.research.components.memory.approaches.experience_store.experiments.selfplay_generate import KRRKBP_FIXED_START, openings_from_fixed_start
...
def main():
    ...
    ap.add_argument("--out-dir", default=str(paths.experiments_dir()))
    args = ap.parse_args()
