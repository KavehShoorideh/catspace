#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/gen_pairwise_data.py -- STRONG-OPPONENT pairwise distance data for the
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("pairwise_tb_v1.npz"))
