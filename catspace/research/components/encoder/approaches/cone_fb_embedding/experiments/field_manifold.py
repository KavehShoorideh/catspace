#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/field_manifold.py -- does the geometry field's embedding space cluster
...
Usage: .venv/bin/python catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/field_manifold.py --ckpt data/derived/sep/iqe_geom.pt
"""
...
ap.add_argument("--out", default=paths.experiment("field_manifold.png"))
args = ap.parse_args()
