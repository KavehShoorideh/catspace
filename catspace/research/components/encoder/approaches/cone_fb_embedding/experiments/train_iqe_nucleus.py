#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_iqe_nucleus.py — the IQE tablebase FOUNDATION on the Lichess
...
Usage:
  .venv/bin/python catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_iqe_nucleus.py --steps 6000 \
...
from catspace.research.components.encoder.approaches.jepa_tokenizer.src.fb import TorchFB, pick_device, save_ckpt
...
def main():
    ...
    ap.add_argument("--out", default=paths.sep("iqe_nucleus.pt"))
