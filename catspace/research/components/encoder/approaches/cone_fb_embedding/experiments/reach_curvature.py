#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/reach_curvature.py — how much CURVATURE (usable gradient) has the
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("reach_curvature.jsonl"),
