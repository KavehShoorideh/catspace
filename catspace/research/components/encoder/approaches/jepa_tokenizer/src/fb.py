...
from catspace.research.components.encoder.approaches.jepa_tokenizer.src.features import N_CLOCK_BINS, N_ELO_BINS, N_PLANES
...
def save_ckpt(fb: TorchFB, path, step: int = 0, opt: torch.optim.Optimizer | None = None,
    ...
    provenance: catspace.research.tools.stats_eval.audit.build_provenance(...) output, if the caller
