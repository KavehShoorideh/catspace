#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/jepa_tokenizer/experiments/train_jepa_t1.py -- T1 of the anchored JEPA (Kaveh's draft §3.3, §3.7):
...
from catspace.research.infra import (PreemptGuard, RunLogger, latest_resumable,           # noqa: E402
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("jepa_t1"))
