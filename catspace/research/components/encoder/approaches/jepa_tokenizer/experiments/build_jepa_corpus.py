#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/jepa_tokenizer/experiments/build_jepa_corpus.py -- T1 corpus for the anchored JEPA (paper §3.2-3.3):
...
def main():
    ...
    ap.add_argument("--checkpoints", default=paths.derived("checkpoints/checkpoints_v1_full.npz"))
    ...
    ap.add_argument("--out", default=paths.derived("checkpoints/jepa_t1_corpus.npz"))
