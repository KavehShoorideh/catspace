#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/concept_reach_rollout.py -- the linchpin "concept as a navigable subgoal" test
