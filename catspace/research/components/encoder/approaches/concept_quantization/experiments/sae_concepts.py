#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/sae_concepts.py -- native concept discovery via a SPARSE AUTOENCODER (Kaposi 2026-07-21:
