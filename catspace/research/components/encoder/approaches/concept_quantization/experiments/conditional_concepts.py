#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/conditional_concepts.py -- concepts are CONDITIONAL (Kaposi 2026-07-21): the same
