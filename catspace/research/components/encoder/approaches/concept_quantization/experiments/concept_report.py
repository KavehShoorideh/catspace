#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/concept_report.py -- a CONTRASTIVE visual report of the SAE concept DIRECTIONS (Kaposi
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("concept_report.html"))
    ...
    from catspace.research.components.encoder.approaches.concept_quantization.experiments.conditional_concepts import openness as _openness
