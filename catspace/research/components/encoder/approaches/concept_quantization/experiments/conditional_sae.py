#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/conditional_sae.py -- the FULL covariate-conditioned sparse autoencoder (Kaposi
