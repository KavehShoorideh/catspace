#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/opening_alphabet.py -- the opening ALPHABET from real game DYNAMICS (Kaposi 2026-07-21,
...
from catspace.research.components.planner.approaches.atlas_region_stats.experiments.metastable_macrostates import (build_eco_book, coarse_transition, pos_key,
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("opening_alphabet"))
