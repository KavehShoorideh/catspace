#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/concept_features.py -- which INTERPRETABLE features did the value field keep? (Kaposi
