#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/m3b_sae_concepts.py -- M3b concept mining, NO HAND-CODED FEATURES (Kaveh
...
from catspace.research.components.planner.approaches.atlas_region_stats.experiments.m3b_factors import build_strata, stratified_effect     # noqa: E402
...
def main():
    ...
    ap.add_argument("--tokens-cache", default=paths.derived("m3b_trunk_tokens.npz"))
    ...
    out = Path(paths.experiment("m3b_atom_catalog.npz"))
    ...
    torch.save({"state_dict": sae.state_dict(), "dict_size": args.dict_size, "k": args.k,
                "C": C}, paths.experiment("m3b_sae_latest.pt"))
