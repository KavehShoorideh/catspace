#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/conditional_sae_dl.py -- the maintained SAE, FORKED to add conditioning (Kaposi
...
from catspace.research.components.encoder.approaches.concept_quantization.experiments.conditional_concepts import openness
from catspace.research.components.encoder.approaches.concept_quantization.experiments.sae_concepts import heatmap
