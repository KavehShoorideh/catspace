#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/concept_quantization/experiments/subgoal_codebook.py -- rank concepts as planner subgoals by NAVIGABILITY x VALUE
