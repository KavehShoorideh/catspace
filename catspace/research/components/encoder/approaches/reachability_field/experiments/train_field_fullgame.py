#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_field_fullgame.py -- the PROPER FULL-BOARD field (Kaveh 2026-07-26: "train a
...
gates; Ray Tune sweep optional). All losses are the tested ones (catspace/research/tools/training_infra/losses.py).
...
from catspace.research.tools.training_infra.losses import quasimetric_regression, wdl_hinge, categorical_ending_loss
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("field_fullgame"))
