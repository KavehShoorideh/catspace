#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_lc0_field.py -- the CORRECT arch (Kaveh): SINGLE-SPACE (shared phi) IQE
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("traj_lc0_v2.npz"))
    ...
    ap.add_argument("--device", default="auto"); ap.add_argument("--save", default=paths.experiment("lc0_field_correct.pt"))
