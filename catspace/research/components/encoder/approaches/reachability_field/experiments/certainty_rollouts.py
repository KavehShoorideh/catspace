#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/reachability_field/experiments/certainty_rollouts.py — per-state P(reach mate) from stochastic rollouts.
...
def main():
    ...
    ap.add_argument("--starts", default=paths.experiment("krrkbp_win_starts.json"))
    ...
    ap.add_argument("--out", default=paths.experiment("certainty_table.json"))
