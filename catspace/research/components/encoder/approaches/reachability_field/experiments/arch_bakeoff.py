#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/arch_bakeoff.py -- ARCHITECTURE BAKE-OFF (Kaveh 2026-07-25: 'change the
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("move_selection_full_v1.npz"))
