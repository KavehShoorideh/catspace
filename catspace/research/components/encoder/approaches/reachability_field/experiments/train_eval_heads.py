#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/reachability_field/experiments/train_eval_heads.py — train the two eval heads (descriptive WDL
...
from catspace.research.components.encoder.approaches.jepa_tokenizer.src.eval_head import (EvalHead, descriptive_loss, normative_loss, save_heads)
from catspace.research.components.encoder.approaches.jepa_tokenizer.src.fb import load_ckpt, pick_device
from catspace.research.components.encoder.approaches.jepa_tokenizer.src.features import elo_bin, feature_planes, omega_ids, winprob_cp
