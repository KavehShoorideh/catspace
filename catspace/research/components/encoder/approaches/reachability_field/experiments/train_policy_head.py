#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/reachability_field/experiments/train_policy_head.py — behavioral-cloning MOVE-PRIOR head on a
...
Usage:
  .venv/bin/python catspace/research/components/encoder/approaches/reachability_field/experiments/train_policy_head.py            # incumbent
  .venv/bin/python catspace/research/components/encoder/approaches/reachability_field/experiments/train_policy_head.py --ckpt <field>.pt --n 200000
"""
