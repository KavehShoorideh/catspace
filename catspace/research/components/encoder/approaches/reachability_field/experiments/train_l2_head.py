#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_l2_head.py -- the L2 categorical OUTCOME head on top of the frozen
...
def main():
    ...
    ap.add_argument("--l1", default=paths.sep("iqe_geom_min.pt"))
    ap.add_argument("--data", default=paths.derived("lichess_nearmate.npz"))
    ap.add_argument("--out", default=paths.sep("l2_head.pt"))
