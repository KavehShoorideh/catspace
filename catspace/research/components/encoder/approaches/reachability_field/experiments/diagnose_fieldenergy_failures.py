#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/diagnose_fieldenergy_failures.py -- WHY is fieldenergy 0.79 and not 1.00 on
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.ladder_mate import white_mcts
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.mate_ladder_eval import make_energy_prior, make_field_value, sample_scenarios
