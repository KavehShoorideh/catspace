#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/gen_child_rank_data.py -- S2d data: the LOCAL move-selection signal the field
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("child_rank_v1.npz"))
