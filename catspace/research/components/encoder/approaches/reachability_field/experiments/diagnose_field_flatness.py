#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/diagnose_field_flatness.py -- WHY does the engine draw in won positions?
...
def main():
    ...
    pfn = None
    if args.energy_ckpt:
        from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.mate_ladder_eval import make_energy_prior
