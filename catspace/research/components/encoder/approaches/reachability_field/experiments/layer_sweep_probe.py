#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/layer_sweep_probe.py -- per-layer readout sweep + a POSITIVE CONTROL,
...
Usage:
  catspace/research/components/encoder/approaches/reachability_field/experiments/layer_sweep_probe.py --trunk jepa
  catspace/research/components/encoder/approaches/reachability_field/experiments/layer_sweep_probe.py --trunk lc0-small
  catspace/research/components/encoder/approaches/reachability_field/experiments/layer_sweep_probe.py --trunk lc0-big
"""
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.hanging_piece_probe import captured_square  # noqa: E402
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.hanging_piece_probe_lc0 import pov_square_index  # noqa: E402
from catspace.research.components.encoder.approaches.reachability_field.experiments.probe_readout import linear_readout, mlp_readout_with_control  # noqa: E402
...
def main():
    ...
    ap.add_argument("--jepa-ckpt", default=paths.experiment("jepa_t1_latest.pt"))
    ap.add_argument("--lc0-small-onnx", default=paths.engine("lc0/t1-256x10.onnx"))
    ap.add_argument("--lc0-big-onnx", default=paths.engine("lc0/t1-512x15x8h.onnx"))
    ...
    out = args.out or paths.experiment(f"layer_sweep_{args.trunk}")
    ...
    fig.savefig(paths.figure(f"{Path(out).name}.png"), dpi=130)
