#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_clock_field.py -- CLOCK-AWARE mate field (Kaveh). Uses the FULL 20-plane
...
(the toy tokens() dropped the clock). Tested losses from catspace/research/tools/training_infra/losses.py.
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("clock_child_v1.npz"))
    ...
    ap.add_argument("--device", default="auto"); ap.add_argument("--save", default=paths.experiment("clock_field_v1.pt"))
