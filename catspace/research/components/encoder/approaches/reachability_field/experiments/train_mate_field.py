#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_mate_field.py -- S2 (METASTABILITY_PLAN): a field that actually MATES.
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("wdl_dtm_v1.npz"))
    ...
    ap.add_argument("--save", default=paths.experiment("mate_field_v1.pt"))
