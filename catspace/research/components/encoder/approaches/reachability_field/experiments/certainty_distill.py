#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/reachability_field/experiments/certainty_distill.py — distill the certainty field into the slow embedding.
...
def main():
    ...
    ap.add_argument("--ckpt-in", default=paths.derived("lichess_fb_4gb_qm_plygap_only.pt"))
    ap.add_argument("--ckpt-out", default=paths.sep("certainty_distill.pt"))
    ap.add_argument("--table", default=paths.experiment("certainty_table.json"))
