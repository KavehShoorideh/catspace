#!/usr/bin/env python
"""
catspace/research/components/encoder/approaches/reachability_field/experiments/two_channel_distill.py — split the field into TWO channels
...
def main():
    ...
    ap.add_argument("--ckpt-in", default=paths.sep("cert_base_full.pt"))
    ap.add_argument("--ckpt-out", default=paths.sep("two_channel.pt"))
    ap.add_argument("--plies-table", default=paths.experiment("certainty_table_eps05.json"))
    ap.add_argument("--sharp-table", default=paths.experiment("sharpness_table.json"))
    ap.add_argument("--shards", default=paths.shards("lichess_db_standard_rated_2019-01.prefix4gb"))
    ...
    from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.train_lichess_fb import batch_tensors, build_zgoals
