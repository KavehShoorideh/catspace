#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_field_full.py -- the CONSOLIDATED best-candidate field (Kaveh: include ALL
...
def main():
    ...
    ap.add_argument("--pair", default=paths.derived("pairwise_tb_v1.npz"))
    ap.add_argument("--child", default=paths.derived("child_rank_v1.npz"))
    ...
    ap.add_argument("--save", default=paths.experiment("field_full_v1.pt"))
