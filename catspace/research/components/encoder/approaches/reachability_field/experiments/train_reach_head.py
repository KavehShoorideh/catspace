#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/train_reach_head.py -- v1 z-conditioned first-hit reachability head
...
Losses imported from catspace/research/tools/training_infra/losses.py (first_hit_bce, censored_plies_loss -- tested).
Data: catspace/research/components/planner/approaches/reach_field/experiments/build_reach_data.py output (materialized labels; in_now pairs excluded).
...
from catspace.research.tools.training_infra.losses import censored_plies_loss, first_hit_bce      # noqa: E402
...
def main():
    ...
    ap.add_argument("--data", default=paths.reach("reach_v1.npz"))
    ap.add_argument("--zckpt", default=paths.experiment("m2b_style_3k.pt"))
    ap.add_argument("--zopp", default="", help="zopp_causal_v1.npz path; empty = v1 (no opponent slot)")
    ap.add_argument("--out", default=paths.experiment("reach_v1"))
