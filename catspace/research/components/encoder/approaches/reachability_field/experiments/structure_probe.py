#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/structure_probe.py -- is STRUCTURE present in F / B, or discarded? (Kaposi 2026-07-21).
