#!/usr/bin/env python
"""catspace/research/components/encoder/approaches/reachability_field/experiments/distill_validate.py -- validate the DISTILLATION teacher (Kaveh 2026-07-21): MCTS searches a
