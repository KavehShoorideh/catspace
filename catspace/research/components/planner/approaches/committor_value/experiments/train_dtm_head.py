#!/usr/bin/env python
"""catspace/research/components/planner/approaches/committor_value/experiments/train_dtm_head.py — a DECOUPLED distance-to-mate head (Kaveh
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/committor_value/experiments/train_dtm_head.py --ckpt data/derived/sep/cert_base_full.pt \
...
def main():
    ...
    ap.add_argument("--out", default=paths.sep("cert_base_full_dtmhead.pt"))
