#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/committor_value/experiments/phead_calibration.py — the phead calibration gate + surface viz
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/committor_value/experiments/phead_calibration.py \
...
def main():
    ...
    # ---- surfaces PNG -------------------------------------------------------
    out = args.out_png or paths.experiment(f"phead_surfaces_{Path(args.ckpt).stem}.png")
    import matplotlib
    matplotlib.use("Agg")
