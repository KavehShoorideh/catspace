#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/committor_value/experiments/committor_distill.py — Stage 1 of the probability-first-class
...
def main():
    ...
    ap.add_argument("--ckpt-out", default=paths.sep("committor.pt"))
    ap.add_argument("--table", default=paths.experiment("certainty_table_r2_K16.json"))
