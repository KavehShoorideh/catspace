#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/committor_value/experiments/decision_flip_probe.py — does deep search CHANGE decisions, and
...
def main():
    ...
    out = Path(paths.experiment("decision_flip_probe.json"))
