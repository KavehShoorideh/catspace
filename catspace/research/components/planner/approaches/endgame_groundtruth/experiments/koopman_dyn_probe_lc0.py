#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/koopman_dyn_probe_lc0.py -- same Koopman-linearization question as
...
Usage:
  catspace/research/components/planner/approaches/endgame_groundtruth/experiments/koopman_dyn_probe_lc0.py --n 4000
"""
...
def main():
    ...
    ap.add_argument("--onnx", default=paths.engine("lc0/t1-512x15x8h.onnx"))
    ...
    ap.add_argument("--out", default=paths.experiment("koopman_dyn_probe_lc0"))
    args = ap.parse_args()
    t0 = time.time()
