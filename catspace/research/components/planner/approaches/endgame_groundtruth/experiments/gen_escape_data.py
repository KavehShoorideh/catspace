#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_escape_data.py -- training data for the LEARNED constraint value
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("escape_data_v1.npz"))
