#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/bench_value_speed.py -- SPEED x FIDELITY bench for field variants (Kaveh:
...
from catspace.research.components.encoder.approaches.reachability_field.experiments.distill_field import load_positions
