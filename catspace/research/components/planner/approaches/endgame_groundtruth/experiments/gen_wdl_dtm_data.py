#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_wdl_dtm_data.py -- S2 data (METASTABILITY_PLAN): fix the field that can't
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("wdl_dtm_v1.npz"))
