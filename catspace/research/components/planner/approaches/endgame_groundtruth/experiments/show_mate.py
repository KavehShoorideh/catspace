#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/show_mate.py — play toy starts (White = field+MCTS, Black =
...
from catspace.research.tools.stats_eval.playout_ab import mate_vector  # reuse loading? no -- need moves; inline
