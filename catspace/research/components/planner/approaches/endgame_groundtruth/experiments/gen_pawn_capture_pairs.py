#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_pawn_capture_pairs.py — PAWN-CAPTURE one-way transitions from
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_pawn_capture_pairs.py --workers 9 \
...
def main():
    ...
    ap.add_argument("--in", dest="inp", default=paths.derived("lichess_nearmate.npz"))
    ...
    ap.add_argument("--out", default=paths.derived("pawndeath_pairs.npz"))
