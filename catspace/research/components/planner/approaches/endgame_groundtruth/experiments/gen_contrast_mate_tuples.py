#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_contrast_mate_tuples.py -- Kaveh 2026-07-22: the matched-anchor
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("contrast_mate_tuples.npz"))
