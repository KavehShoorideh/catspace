#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_dtm_cnn.py -- a PLAIN CNN value net (no quasimetric) that regresses DTM from the board,
...
from catspace.research.components.planner.approaches.endgame_groundtruth.src.dtm import DTMNet  # component home (refactor 2026-07-30)
...
def main():
    ...
    ap.add_argument("--out", default=paths.sep("dtm_cnn.pt"))
