#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_composed_ab.py — does the COMPOSED RETRIEVAL readout
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_composed_ab.py --n 60 --nodes 400
"""
...
def main():
    ...
    ap.add_argument("--ckpt-a", default=paths.sep("cert_base_full.pt"))
    ap.add_argument("--phead-a", default=paths.sep("cert_base_full_phead.pt"))
    ap.add_argument("--ckpt-b", default=paths.sep("qrl_iqe_sn_full.pt"))
    ap.add_argument("--dtm-npz", default=paths.derived("dtm_endgame.npz"))
    ap.add_argument("--forced-mate", default=paths.derived("forced_mate.npz"))
