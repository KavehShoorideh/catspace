#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/koopman_dyn_probe.py -- "go the Koopman way" (Kaveh 2026-07-31): does
...
Usage:
  catspace/research/components/planner/approaches/endgame_groundtruth/experiments/koopman_dyn_probe.py --n 8000
"""
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("koopman_dyn_probe"))
    args = ap.parse_args()
    t0 = time.time()
