#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_board_policy.py — a BOARD policy net that predicts the
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_board_policy.py --epochs 60 \
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("dtm_policy.npz"))
    ap.add_argument("--out", default=paths.sep("board_policy.pt"))
