#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_compare.py — paired KRRvKBP conversion, checkpoint A vs B.
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.krrkbp_arena import run_paired
