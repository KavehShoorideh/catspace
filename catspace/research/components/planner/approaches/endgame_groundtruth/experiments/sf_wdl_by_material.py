#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/sf_wdl_by_material.py -- perfect-vs-human committor by MATERIAL, on the SAME positions.
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("sf_wdl_by_material.png"))
