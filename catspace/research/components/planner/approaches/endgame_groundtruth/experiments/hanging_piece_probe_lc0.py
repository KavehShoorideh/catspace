#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/hanging_piece_probe_lc0.py -- Kaveh's question: does the RAW frozen lc0
...
ground truth as catspace/research/components/planner/approaches/endgame_groundtruth/experiments/hanging_piece_probe.py (SF committor swing across an
...
Usage:
  catspace/research/components/planner/approaches/endgame_groundtruth/experiments/hanging_piece_probe_lc0.py --hang-thr 0.25 --fair-thr 0.05
"""
...
def main():
    ...
    ap.add_argument("--onnx", default=paths.engine("lc0/t1-256x10.onnx"))
    ...
    ap.add_argument("--out", default=paths.experiment("hanging_piece_probe_lc0"))
    args = ap.parse_args()
    t0 = time.time()
