#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/sf_label_transitions.py -- M2a: add OBJECTIVE crossing labels to the transition data.
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("transition_data.npz"))
