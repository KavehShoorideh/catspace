#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/mine_mate_puzzles.py — permanent mate-in-N benchmark sets from the
...
def main():
    ...
    ap.add_argument("--puzzle-db", default=str(paths.puzzle_db()))
