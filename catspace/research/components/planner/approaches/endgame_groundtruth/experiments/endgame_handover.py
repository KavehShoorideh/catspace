#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/endgame_handover.py -- the HANDOVER primitive (Kaveh's pivot): the tablebase IS
...
Run `python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/endgame_handover.py` for the self-test.
"""
