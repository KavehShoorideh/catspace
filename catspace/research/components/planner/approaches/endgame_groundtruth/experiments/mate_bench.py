#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/mate_bench.py — score a checkpoint on the mate-in-N benchmark sets
...
def main():
    ...
    ap.add_argument("--sets", nargs="+",
                    default=[paths.experiment("mate_in_1_n500.json"),
                             paths.experiment("mate_in_2_n500.json"),
                             paths.experiment("mate_in_3_n500.json")])
