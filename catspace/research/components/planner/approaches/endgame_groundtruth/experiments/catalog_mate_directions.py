#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/catalog_mate_directions.py -- Kaveh 2026-07-22: "tb isn't optimal [DTZ hangs
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("mate_directions_lichess.png"))
    ap.add_argument("--out-json", default=paths.experiment("mate_directions_catalog.json"))
