#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_board_dtm.py — navigate a won endgame by the BOARD-DTM
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_board_dtm.py --n 30 --nodes 400
"""
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.train_board_dtm import BoardDTM
...
def main():
    ...
    ap.add_argument("--board-dtm", default=paths.sep("board_dtm.pt"))
