#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/catspace_engine.py -- the PLANNER (top layer): a thin CODED POLICY over the
...
from catspace.research.components.encoder.approaches.reachability_field.experiments.compute_layer import ComputeLayer
