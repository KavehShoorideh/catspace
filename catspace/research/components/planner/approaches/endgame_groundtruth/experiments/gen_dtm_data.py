#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_dtm_data.py — tablebase DISTANCE-TO-MATE data for the DTM-hinge
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_dtm_data.py --per 12000 --out data/derived/dtm_endgame.npz
"""
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("dtm_endgame.npz"))
