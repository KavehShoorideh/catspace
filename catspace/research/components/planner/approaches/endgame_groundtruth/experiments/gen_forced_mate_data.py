#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_forced_mate_data.py — curate FULL-BOARD forced-mate positions
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/gen_forced_mate_data.py --cap 40000 \
...
def main():
    ...
    ap.add_argument("--puzzles", default=str(paths.puzzle_db()))
    ap.add_argument("--out", default=paths.derived("forced_mate.npz"))
