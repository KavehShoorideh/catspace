#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_krrk.py — curriculum PI training on KRRk (stratified union chain)."""
...
from catspace.research.tools.chess_specific.domains import krrk
