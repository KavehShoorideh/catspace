#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/forced_mate_set.py — build + VALIDATE a forced-mate position set.
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("forced_mate_set.json"))
