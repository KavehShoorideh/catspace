#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/defender_circuit_probe.py -- does the JEPA T1 trunk have a legible
...
Usage:
  catspace/research/components/planner/approaches/endgame_groundtruth/experiments/defender_circuit_probe.py --n-readout 4000 --n-causal 200
"""
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("defender_circuit_probe"))
    args = ap.parse_args()
    t0 = time.time()
