#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/endgame_groundtruth/experiments/krrkbp_arena.py — matched-pair comparison of two White policies
...
def main():
    ...
    ap.add_argument("--fixed-set", default=paths.experiment("krrkbp_fixed_set.json"))
    ...
    ap.add_argument("--bank-shards", nargs="+", default=[paths.selfplay("gen2"), paths.selfplay("gen1")],
