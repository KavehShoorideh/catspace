#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_escape_net.py -- the LEARNED constraint head: board -> predicted black-king
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("escape_data_v1.npz"))
    ap.add_argument("--steps", type=int, default=6000)
    ap.add_argument("--batch", type=int, default=256)
    ap.add_argument("--lr", type=float, default=1e-3)
    ap.add_argument("--scale", type=float, default=8.0)
    ap.add_argument("--out", default=paths.sep("escape_net_v1.pt"))
