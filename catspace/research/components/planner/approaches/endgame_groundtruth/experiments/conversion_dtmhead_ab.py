#!/usr/bin/env python
"""catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_dtmhead_ab.py — SAME field, committor vs DTM-head
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/endgame_groundtruth/experiments/conversion_dtmhead_ab.py --n 30 --nodes 400
"""
...
from catspace.research.components.planner.approaches.committor_value.experiments.train_dtm_head import DTMHead
...
def main():
    ...
    ap.add_argument("--dtmhead", default=paths.sep("cert_base_full_dtmhead.pt"))
