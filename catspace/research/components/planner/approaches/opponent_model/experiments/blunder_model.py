#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/blunder_model.py -- LAYER 1 (stopgap, open-source): predict WHERE an opponent of a
