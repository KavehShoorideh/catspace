#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/train_opponent_model.py -- train the option-A opponent model
...
def main():
    ...
    ap.add_argument("--data", default=paths.derived("move_selection_v1.npz"),
    ...
    ap.add_argument("--out", default=paths.sep("opponent_v1.pt"))
