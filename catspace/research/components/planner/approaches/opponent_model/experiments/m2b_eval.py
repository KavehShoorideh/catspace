#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/m2b_eval.py -- M2b gate: does the recovered style residual z improve held-out move
...
def main():
    ...
    ap.add_argument("--model", default=paths.experiment("m2b_style.pt"))
