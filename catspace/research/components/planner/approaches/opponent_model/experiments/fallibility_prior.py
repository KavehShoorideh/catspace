#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/opponent_model/experiments/fallibility_prior.py — Stage 4: MEASURED population fallibility prior.
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("fallibility_prior.json"))
    args = ap.parse_args()
