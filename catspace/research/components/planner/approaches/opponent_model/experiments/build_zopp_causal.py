#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/build_zopp_causal.py -- the CAUSAL in-game opponent-style estimate for the reach
...
def main():
    ...
    ap.add_argument("--opp-cache", default=paths.derived("m2b/cache_dense_opp"))
    ap.add_argument("--reach", default=paths.reach("reach_v1.npz"))
    ap.add_argument("--model", default=paths.experiment("m2b_style_3k.pt"))
    ap.add_argument("--train-cache", default=paths.derived("m2b/cache_3k.npz"),
                    help="source of per-player train Elos (z-table retrieval bands)")
    ap.add_argument("--out", default=paths.reach("zopp_causal_v1.npz"))
