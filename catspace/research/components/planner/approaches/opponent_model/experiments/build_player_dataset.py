#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/build_player_dataset.py -- M2b data: extract the games of HIGH-VOLUME players from the
...
def main():
    ...
    ap.add_argument("--out", default=paths.records("player_games_rapid"))
