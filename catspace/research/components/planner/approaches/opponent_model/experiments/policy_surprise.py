#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/opponent_model/experiments/policy_surprise.py — assess a policy head by its SURPRISE at the
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/opponent_model/experiments/policy_surprise.py --n 150 --nodes 800
"""
...
def main():
    ...
    ap.add_argument("--policy", default=paths.sep("cert_base_full_policy.pt"))
