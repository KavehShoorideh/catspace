#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/m2c_elo_id.py -- M2c unknown-Elo path: can we RECOVER a hidden Elo from a player's moves?
