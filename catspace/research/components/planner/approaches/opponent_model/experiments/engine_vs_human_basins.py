#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/engine_vs_human_basins.py -- Kaveh's control: do the 3 W/D/L basins come out SHARP
...
def main():
    ...
    ap.add_argument("--engine", default=paths.derived("engine_sfsf.npz"))
    ap.add_argument("--human", default=paths.derived("field_fullgame_v1.npz"))
    ap.add_argument("--n", type=int, default=20000)
    ap.add_argument("--out", default=paths.experiment("engine_vs_human_basins.png"))
