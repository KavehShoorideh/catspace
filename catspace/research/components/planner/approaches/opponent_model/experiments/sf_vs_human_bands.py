#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/sf_vs_human_bands.py -- the 3-basin BANDS + basin transition MATRIX, side by side for
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("sf_vs_human_bands.png"))
