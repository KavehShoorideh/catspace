#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/m2b_sample.py -- M2b step 1: sample MIDGAME positions (ply >= --min-ply) where the
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("m2b/positions.parquet"))
