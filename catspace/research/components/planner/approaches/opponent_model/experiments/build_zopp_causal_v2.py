#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/build_zopp_causal_v2.py -- causal opponent-style estimates for the v2 reach data.
...
(catspace/research/components/planner/approaches/opponent_model/experiments/build_zopp_causal.py, kept for provenance).
...
def main():
    ...
    ap.add_argument("--out", default=paths.reach("zopp_causal_v2.npz"))
