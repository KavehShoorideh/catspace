#!/usr/bin/env python
"""catspace/research/components/planner/approaches/opponent_model/experiments/m2b_cache.py -- M2b step 2: cache the two FROZEN feature sources for every sampled
...
def main():
    ...
    ap.add_argument("--positions", default=paths.derived("m2b/positions.parquet"))
    ap.add_argument("--out", default=paths.derived("m2b/cache"), help="OUTPUT DIRECTORY (shard layout)")
