...
The fast-field re-pricing half of this module now lives with the search component
(search/puct_mcts/src/repricing.py); this file owns the scoring/policy half.
...
from catspace.research.components.search.approaches.puct_mcts.src.repricing import (
    effective_distance,
)
