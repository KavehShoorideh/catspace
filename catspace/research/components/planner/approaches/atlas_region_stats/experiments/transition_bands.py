#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/transition_bands.py -- the 3 metastable basins as 3 BANDS full of states, each state
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("transition_bands.png"))
