#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/atlas_region_stats/experiments/rim_staircase.py — WHY is the field flat near mate? (Kaveh
...
def main():
    ...
    ap.add_argument("--ckpt", default=paths.sep("rootloop_r12.pt"))
    ap.add_argument("--whead", default=paths.sep("rootloop_r12_whead.pt"))
