#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/diag_region_nav.py -- WHY does quasimetric dist-to-region fail to navigate to the region
...
from catspace.research.components.encoder.approaches.concept_quantization.experiments.steer_concept import embed_F
