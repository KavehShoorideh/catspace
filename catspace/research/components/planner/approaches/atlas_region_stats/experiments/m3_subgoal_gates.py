#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/m3_subgoal_gates.py -- the M3 DoD gates (MILESTONES M3), printed as VERDICTs:
...
def main():
    ...
    ap.add_argument("--table", default=paths.reach("region_table_v1.npz"))
