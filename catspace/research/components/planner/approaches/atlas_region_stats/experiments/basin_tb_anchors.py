#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/basin_tb_anchors.py -- Kaveh's ask (2026-08-02): use the exactly
...
def main():
    ...
    fig1.savefig(paths.experiment("tb_anchor_1_basin_rollup_dendrogram.png"), dpi=140)
    fig1.savefig(paths.figure("tb_anchor_1_basin_rollup_dendrogram.png"), dpi=140)
    ...
    n_traj = 4
    human_games = select_n_human_games_full(paths.records("lichess_2019-01"), paths.derived("field_std_v1.npz"), n_traj, seed, 20)
    sf_games = select_n_sf_games_full(paths.derived("opening_pool_sfsf_moves.tsv"), n_traj, seed, 21)
    ...
    fig2.savefig(paths.experiment("tb_anchor_2_trajectories.png"), dpi=140)
    fig2.savefig(paths.figure("tb_anchor_2_trajectories.png"), dpi=140)
    ...
    n_rate = 25
    human_games_r = select_n_human_games_full(paths.records("lichess_2019-01"), paths.derived("field_std_v1.npz"), n_rate, seed, 30)
    sf_games_r = select_n_sf_games_full(paths.derived("opening_pool_sfsf_moves.tsv"), n_rate, seed, 31)
    ...
    np.savez(paths.experiment("tb_anchor_data.npz"),
