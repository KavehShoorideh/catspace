#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/propagation_ladder.py — does the field propagate an ENDGAME value
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/atlas_region_stats/experiments/propagation_ladder.py --ckpt data/derived/sep/cert_base_full.pt
"""
...
def main():
    ...
    from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.train_lichess_fb import collect_mate_finals
