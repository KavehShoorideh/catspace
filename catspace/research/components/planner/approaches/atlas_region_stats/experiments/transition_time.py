#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/transition_time.py -- the 3 metastable basins over the GAME TIMELINE (Kaveh: one axis
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("transition_time.png"))
