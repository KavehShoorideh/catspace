#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/basin_metastability.py -- Kaveh's ask (2026-08-02): "do all four
...
from catspace.research.tools.embeddings.basin_umap_compare import (   # noqa: E402
...
def main():
    ...
    human = load_sample(paths.derived("field_std_v1.npz"), n_density, seed, 0)
    sf = load_sample(paths.derived("opening_pool_sfsf.npz"), n_density, seed, 1)
    ...
    human_games = select_n_human_games_full(paths.records("lichess_2019-01"), paths.derived("field_std_v1.npz"), n_games, seed, 10)
    sf_games = select_n_sf_games_full(paths.derived("opening_pool_sfsf_moves.tsv"), n_games, seed, 11)
    ...
    fig1.tight_layout()
    fig1.savefig(paths.experiment("meta_1_tica_side_by_side.png"), dpi=140)
    Path(str(paths.figures_dir())).mkdir(exist_ok=True, parents=True)
    fig1.savefig(paths.figure("meta_1_tica_side_by_side.png"), dpi=140)
    ...
    fig2.tight_layout()
    fig2.savefig(paths.experiment("meta_2_tica_contours_trajectories.png"), dpi=140)
    fig2.savefig(paths.figure("meta_2_tica_contours_trajectories.png"), dpi=140)
    ...
    fig3.tight_layout()
    fig3.savefig(paths.experiment("meta_3_pcca_macrostates.png"), dpi=140)
    fig3.savefig(paths.figure("meta_3_pcca_macrostates.png"), dpi=140)
    ...
    fig4.tight_layout()
    fig4.savefig(paths.experiment("meta_4_disconnectivity_dendrogram.png"), dpi=140)
    fig4.savefig(paths.figure("meta_4_disconnectivity_dendrogram.png"), dpi=140)
    ...
    fig5.tight_layout()
    fig5.savefig(paths.experiment("meta_5_flux_diagram.png"), dpi=140)
    fig5.savefig(paths.figure("meta_5_flux_diagram.png"), dpi=140)

    np.savez(paths.experiment("meta_data.npz"),
