#!/usr/bin/env python
"""catspace/research/components/planner/approaches/atlas_region_stats/experiments/m3_flux_gate.py -- M3 DoD gate: does PREDICTED crossing-flux find where opponents
...
from catspace.research.components.planner.approaches.atlas_region_stats.experiments.train_transition_estimator import context_feats, T
