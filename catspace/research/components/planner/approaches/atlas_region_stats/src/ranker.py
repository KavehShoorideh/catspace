...
class SubgoalRanker:
    def __init__(self, field_ckpt: str, reach_npz: str, region_table: str,
        ...
        from catspace.research.components.planner.approaches.reach_field.src.head import ReachHead
        ...
        if flux_t:                              # learned continuous flux scorer (M3 design path)
            from catspace.research.components.planner.approaches.atlas_region_stats.src.transition import T as TNet
