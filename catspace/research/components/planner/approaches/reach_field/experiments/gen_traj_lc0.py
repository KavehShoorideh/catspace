#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/gen_traj_lc0.py -- REAL-history trajectory data, lc0 (lczerolens) 112-plane
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("traj_lc0_v2.npz")); ap.add_argument("--seed", type=int, default=0)
    args = ap.parse_args()
