#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/build_reach_data.py -- v1 dataset for the z-conditioned first-hit reachability head
...
def main():
    ...
    ap.add_argument("--out", default=paths.reach("reach_v1.npz"))
