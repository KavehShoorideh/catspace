#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/diag_transfer.py -- did completing human trajectories into the endgame make the field's
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.conversion_field_subgoal import FieldSubgoalPlanner
