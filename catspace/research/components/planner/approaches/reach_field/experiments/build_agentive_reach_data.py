#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/build_agentive_reach_data.py -- AGENTIVE first-hit labels from OUR OWN
...
def main():
    ...
    ap.add_argument("--pgns", nargs="+",
                    default=[paths.experiment("m5_read100*.pgn")],
    ...
    ap.add_argument("--out", default=paths.reach("agentive_v1.npz"))
    ap.add_argument("--out-zopp", default=paths.reach("agentive_v1_zopp.npz"))
    args = ap.parse_args()
    t0 = time.time()
