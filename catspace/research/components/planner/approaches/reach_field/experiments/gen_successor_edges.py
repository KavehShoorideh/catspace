#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/gen_successor_edges.py -- LEGAL-SUCCESSOR edges for the geometry
...
Usage:
  .venv/bin/python catspace/research/components/planner/approaches/reach_field/experiments/gen_successor_edges.py --workers 9 --k 8 \
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("successor_edges.npz"))
