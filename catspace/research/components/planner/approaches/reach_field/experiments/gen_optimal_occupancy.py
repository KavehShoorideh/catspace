#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/gen_optimal_occupancy.py -- the OPTIMAL-PLAY OCCUPANCY for <=6 (Kaveh 2026-07-20):
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.gen_stratified_perfect import ALL_MENUS, STRATA_MENUS, optimal_line
...
def main():
    ...
    ap.add_argument("--out", default=paths.derived("optimal_occupancy.npz"))
