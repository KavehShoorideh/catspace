#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/build_reach_positions_v2.py -- SCALED positions for the reach-field power test
...
def main():
    ...
    ap.add_argument("--records", default=paths.records("player_games_rapid"))
    ap.add_argument("--zcache", default=paths.derived("m2b/cache_3k.npz"),
                    help="source of the player_id -> pidx mapping (the z-table membership)")
    ap.add_argument("--out", default=paths.derived("m2b/positions_v2.parquet"))
