#!/usr/bin/env python
"""catspace/research/components/planner/approaches/reach_field/experiments/reach_efficiency.py -- does the field make COARSE long-range navigation more EFFICIENT?
