#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/subgoal_cascade/experiments/sharpness_bench.py — GROUND-TRUTH SHARPNESS benchmark.
...
from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.qm_fitness_probe import random_krvk
