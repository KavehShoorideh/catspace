#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/subgoal_cascade/experiments/sharpness_identification.py — identify (existence, sharpness) per
...
def main():
    ...
    ap.add_argument("--tables", nargs="+", default=[
        paths.experiment("certainty_table_eps05.json"),
        paths.experiment("certainty_table_demo_tb.json"),
        paths.experiment("certainty_table_eps20.json")])
    ...
    ap.add_argument("--out", default=paths.experiment("sharpness_table.json"))
    args = ap.parse_args()
