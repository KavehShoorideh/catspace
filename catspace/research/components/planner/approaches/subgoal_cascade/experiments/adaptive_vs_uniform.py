#!/usr/bin/env python
"""
catspace/research/components/planner/approaches/subgoal_cascade/experiments/adaptive_vs_uniform.py — the PLAY test of reliability-gated search
...
def main():
    ...
    ap.add_argument("--competence", default=paths.derived("competence_map.npz"))
