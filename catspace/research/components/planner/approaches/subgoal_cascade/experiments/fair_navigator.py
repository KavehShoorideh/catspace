#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/fair_navigator.py -- the FAIR coarse-navigation test (Kaveh 2026-07-21: compare against an MCTS
...
def main():
    ...
    ap.add_argument("--cnn", default=paths.sep("dtm_cnn.pt"))
