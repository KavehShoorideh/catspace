#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/execution_curves.py -- Kaveh 2026-07-23: "well-executed and poorly executed
...
def main():
    ...
    per_anchor = {}
    files = sorted(glob.glob(paths.shards("regime_rollouts_v1/shard_*.npz")))[:120]
    for f in files:
        z = np.load(f)
