#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/gradient_planner.py -- human-style planning as GRADIENT DESCENT toward a concept
...
def main():
    ...
    ap.add_argument("--field", default=paths.sep("iqe_occupancy.pt"))
