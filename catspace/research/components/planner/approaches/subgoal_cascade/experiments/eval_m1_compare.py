#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/eval_m1_compare.py -- the M1 FAIR-COMPARISON table: ClockField v3 (incumbent, own
...
from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.train_iqe_head import IQEHead, build_pairs
...
def main():
    ...
    ap.add_argument("--v3", default=paths.experiment("field_fullgame_v3_final.pt"))
    ap.add_argument("--heads", nargs="+", default=[
        paths.experiment("iqe_head_maia1500_latest.pt"),
        paths.experiment("iqe_head_maia1900_latest.pt")])
    ap.add_argument("--feats", nargs="+", default=[
        paths.derived("trunk_feats/maia-1500__field_std_v1.npy"),
        paths.derived("trunk_feats/maia-1900__field_std_v1.npy")])
