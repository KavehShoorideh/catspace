#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/move_rank_check.py -- HOW BAD a move-prior is the field? (Kaveh 2026-07-21: the field IS the
...
from catspace.research.components.planner.approaches.endgame_groundtruth.experiments.conversion_field_mcts import FieldMCTS
