#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/eval_m1_gates2.py -- the remaining two M1 gates, v3 vs the frozen-trunk IQE head,
...
def main():
    ...
    ap.add_argument("--head", default=paths.experiment("iqe_head_maia1500_latest.pt"))
