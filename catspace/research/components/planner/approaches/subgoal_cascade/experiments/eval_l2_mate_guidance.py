#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/eval_l2_mate_guidance.py -- the ACCEPTANCE TEST (Kaveh 2026-07-20):
...
def main():
    ...
    ap.add_argument("--l2", default=paths.sep("l2_head.pt"))
