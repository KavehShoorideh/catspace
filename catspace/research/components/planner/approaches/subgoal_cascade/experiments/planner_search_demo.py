#!/usr/bin/env python
"""catspace/research/components/planner/approaches/subgoal_cascade/experiments/planner_search_demo.py -- exercise the pluggable low-level searches
...
fb, _ = load_ckpt(Path(paths.sep("iqe_geom.pt")), dev); fb.eval()
