#!/usr/bin/env python
"""catspace/research/tools/training_infra/gen_rollouts_daemon.py -- CONTINUOUS shared-anchor rollout generation across a
...
REGIMES = {
    ...
    8:  dict(name="maia_1100", kind="lc0",  weights=paths.engine("maia/maia-1100.pb.gz"), nodes=1, temp=1.0),
    9:  dict(name="maia_1500", kind="lc0",  weights=paths.engine("maia/maia-1500.pb.gz"), nodes=1, temp=1.0),
    10: dict(name="maia_1900", kind="lc0",  weights=paths.engine("maia/maia-1900.pb.gz"), nodes=1, temp=1.0),
}
...
def main():
    ...
    ap.add_argument("--shards", default=",".join((
        paths.shards("lichess_db_standard_rated_2019-01.prefix4gb"),
        paths.shards("sf_cont_endgame_v1"))))
