#!/usr/bin/env python
"""catspace/research/tools/ablations/ablate.py -- causal ablation, two granularities. Per the activation-patching
...
Usage:
  catspace/research/tools/ablations/ablate.py dims rep.npz --label wdl [--group gid] [--topk 12]
  catspace/research/tools/ablations/ablate.py board --ckpt jepa_t1_latest.pt --fen "..." --square e5
"""
...
def main():
    ...
    bd.add_argument("--ckpt", default=paths.experiment("jepa_t1_latest.pt"))
