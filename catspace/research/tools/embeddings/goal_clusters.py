#!/usr/bin/env python
"""catspace/research/tools/embeddings/goal_clusters.py -- B-clusters as GOALS/SUBGOALS, and does F predict arrival in them?
...
def main():
    ...
    ap.add_argument("--out", default=paths.experiment("goal_clusters"))
