#!/usr/bin/env python
"""catspace/research/tools/embeddings/visualize_clusters.py — visualize field structure before/after the
...
fields = [("incumbent (cert_base_full)", paths.sep("cert_base_full.pt")),
          ("clustered (cert_base_cluster)", paths.sep("cert_base_cluster.pt"))]
...
out = paths.experiment("field_clusters.png")
