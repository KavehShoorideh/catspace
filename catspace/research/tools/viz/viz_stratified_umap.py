#!/usr/bin/env python
"""catspace/research/tools/viz/viz_stratified_umap.py -- does the BOTTOM-UP stratified field's embedding
...
def main():
    ...
    ap.add_argument("--ckpt", default=paths.sep("iqe_stratified.pt"))
    ...
    ap.add_argument("--out", default=paths.experiment("stratified_umap.png"))
    args = ap.parse_args()
