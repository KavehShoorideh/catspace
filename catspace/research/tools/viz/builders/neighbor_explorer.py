#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/neighbor_explorer.py — interactive embedding-neighbour explorer.
...
Run:  python catspace/research/tools/viz/builders/neighbor_explorer.py --ckpt <ckpt> [--port 8765]
...
from catspace.research.tools.viz.builders.build_embedding_neighbors import (
