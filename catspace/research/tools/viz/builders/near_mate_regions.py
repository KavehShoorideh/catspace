#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/near_mate_regions.py — do NEAR-MATE positions separate in F-space?
...
from catspace.research.tools.viz.builders.wdl_regions import separability, _manifold_2d
...
def main():
    ...
    ap.add_argument("--shards", nargs="+",
                    default=[paths.shards("lichess_db_standard_rated_2019-01.prefix1gb")])
...
def _plot(args, F, y, names, full, reachW, reachB):
    ...
    out = Path(str(paths.generated_dir())) / f"{args.label}_regions.png"
