#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/certainty_structure.py — the 3-panel "did the distill learn the
...
def main():
    ...
    ap.add_argument("--ckpt-incumbent", default=paths.derived("lichess_fb_4gb_qm_plygap_only.pt"))
    ap.add_argument("--ckpt-distilled", default=paths.sep("certainty_full.pt"))
    ...
    ap.add_argument("--out", default=paths.generated("certainty_structure.png"))
