#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_decision_viewer.py — plays FBBoardPolicy vs an opponent
(random or Stockfish) exactly like catspace/approaches/gauntlet_harness/experiments/arena_real.py, but records
