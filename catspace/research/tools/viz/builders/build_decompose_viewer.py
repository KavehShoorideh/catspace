#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_decompose_viewer.py — populate
...
recipe as catspace/research/tools/viz/decompose_demo.py: tau_exec/tau_floor calibrated from
