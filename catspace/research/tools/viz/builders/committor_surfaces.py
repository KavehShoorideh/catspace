#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/committor_surfaces.py — visualize the committor field and its
...
def main():
    ...
    ap.add_argument("--ckpt", default=paths.sep("committor.pt"))
    ap.add_argument("--whead", default=paths.sep("committor_whead.pt"))
    ...
    ap.add_argument("--out", default=paths.generated("committor_surfaces.png"))
    args = ap.parse_args()
