#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_eval_dashboard.py — populate
...
nn/eval_head.py, catspace/research/components/encoder/approaches/reachability_field/experiments/train_eval_heads.py): ROC + AUC, reliability,
