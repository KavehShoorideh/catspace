#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_krkn_viewer.py — build the interactive KRkn linked
...
data/derived/ (produced by catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_krkn.py and
