#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/wdl_regions.py — does the embedding find win / draw / loss regions?
...
from catspace.research.tools.viz.builders.build_embedding_neighbors import Bank, load_bank_positions
...
def main():
    ...
    ap.add_argument("--bank-shards", nargs="+",
                    default=[paths.selfplay("krrkbp_sfsf"), paths.selfplay("krrkbp_pvsf")])
    ...
    out_png = Path(str(paths.generated_dir())) / f"wdl_regions_{label}_{args.pov}.png"
