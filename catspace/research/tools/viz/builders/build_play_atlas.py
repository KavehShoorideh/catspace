#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_play_atlas.py — COMPONENT A of the play-atlas app
...
Usage:
  .venv/bin/python catspace/research/tools/viz/builders/build_play_atlas.py            # incumbent, n=4000
  .venv/bin/python catspace/research/tools/viz/builders/build_play_atlas.py --ckpt <field>.pt --phead <field>_phead.pt \
...
def main():
    ...
    ap.add_argument("--out", default=paths.generated("play_atlas"))
