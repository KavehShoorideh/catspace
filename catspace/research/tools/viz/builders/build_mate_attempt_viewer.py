#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_mate_attempt_viewer.py — WHERE did a mate attempt go in
...
def main():
    ...
    ap.add_argument("--fixed-set", default=paths.experiment("krrkbp_fixed_test_n200.json"))
    ...
    ap.add_argument("--out", default=paths.generated("mate_attempts.html"))
    args = ap.parse_args()
    ...
    for si, fen in enumerate(starts):
        ...
        from catspace.research.tools.stats_eval.stage_checkers import annotate_game
