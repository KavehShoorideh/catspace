#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/static_maps.py — static region-map figures via the pluggable
...
--which krkn: KRkn token-territory + win/draw region map (the domain with a
              trained field from catspace/research/components/planner/approaches/endgame_groundtruth/experiments/train_krkn.py).
...
from catspace.research.tools.viz.viz.plots import style
from catspace.research.tools.viz.viz.projection import fit_map
