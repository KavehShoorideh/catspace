#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/build_training_dashboard.py — parse train_lichess_fb.py logs
...
def main():
    ...
    t0 = time.time()
    patterns = args.logs or [str(Path(__file__).resolve().parents[2] / str(paths.artifacts_dir()) /
