#!/usr/bin/env python
"""
catspace/research/tools/viz/builders/committor_atlas.py — region/surface visualization in the
...
Usage: .venv/bin/python catspace/research/tools/viz/builders/committor_atlas.py \
...
def main():
    ...
    fig.tight_layout()
    out = args.out or paths.experiment(f"committor_atlas_{Path(args.ckpt).stem}.png")
