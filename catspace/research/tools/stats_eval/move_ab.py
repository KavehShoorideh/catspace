#!/usr/bin/env python
"""
catspace/research/tools/stats_eval/move_ab.py — paired MOVE-LEVEL A/B between two checkpoints.
...
import json
from catspace.research.components.encoder.approaches.cone_fb_embedding.experiments.reach_curvature import _reach_children, _tb_truth, optimal_line
