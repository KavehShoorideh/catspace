#!/usr/bin/env python
"""
catspace/research/tools/stats_eval/capacity_forensics.py — is the play-degrades-with-training effect
...
def main():
    ...
    ap.add_argument("--ckpt-stem", default=paths.sep("committor_base_full"))
    ap.add_argument("--steps", type=int, nargs="+",
                    default=[30000, 60000, 90000, 120000, 150000])
    ap.add_argument("--rare-table", default=paths.experiment("certainty_table_r3_K16.json"),
                    help="rare-regime states (toy rook endgames)")
    ap.add_argument("--common-shards", default=paths.shards("lichess_db_standard_rated_2019-01.prefix4gb"))
