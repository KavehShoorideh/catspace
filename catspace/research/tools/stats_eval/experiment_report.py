#!/usr/bin/env python
"""
catspace/research/tools/stats_eval/experiment_report.py — the A/B experimentation harness: audits a
...
SAME e-value machinery (catspace.approaches.gauntlet_harness.experiments.arena_real.run_arena, generalized to
...
# invocation from repo root). Importing catspace.approaches.gauntlet_harness.experiments.arena_real below (to
...
# ------------------------------------------------------------- reach slopes
# duplicated from catspace/research/components/encoder/approaches/cone_fb_embedding/experiments/train_lichess_fb.py::reach_slope rather than
...
# ------------------------------------------------------------- decompose metrics
# duplicated (not imported) from catspace/research/tools/viz/builders/build_decompose_viewer.py
...
def main():
    ...
    from catspace.approaches.gauntlet_harness.experiments.arena_real import make_opponent, run_arena
