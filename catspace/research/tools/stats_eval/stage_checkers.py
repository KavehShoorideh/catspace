#!/usr/bin/env python
"""
catspace/research/tools/stats_eval/stage_checkers.py — EVAL-ONLY named-stage detectors + validation.
...
def main():
    ...
    ap.add_argument("--dump", default=paths.experiment("rollout_dump_eps05.jsonl"))
