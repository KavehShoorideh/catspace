#!/usr/bin/env python
"""catspace/research/tools/probes/probe_quasimetric.py -- probe an asymmetric distance head (quasimetric).
...
Usage: catspace/research/tools/probes/probe_quasimetric.py --pgn artifacts/experiments/m5_read100.pgn \
...
def load_head(name, dev):
    if name == "trunk":
        ...
        cg = CommittorGreedy(paths.experiment("field_fullgame_v3_final.pt"), dev)
