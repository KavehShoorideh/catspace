#!/usr/bin/env python
"""catspace/research/tools/figures/fig_retrieval.py -- nearest-neighbour retrieval grid, FAIR convention
...
Usage:
  catspace/research/tools/figures/fig_retrieval.py --checkpoints data/derived/checkpoints/checkpoints_v1_full.npz \
