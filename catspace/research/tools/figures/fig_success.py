#!/usr/bin/env python
"""catspace/research/tools/figures/fig_success.py -- success-rate comparison in the robotics-evaluation
...
Usage: catspace/research/tools/figures/fig_success.py results.csv --fig success.png [--baseline 0.125]
"""
